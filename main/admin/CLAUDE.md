...
- `CKEditorWidget` (`forms.py` / `views.py`): полная статика CKEditor 4 лежит в [main/core/ckeditor/](../core/ckeditor/) (как в пакете django-ckeditor, без CDN / без collectstatic на сервере).
