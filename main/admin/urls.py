...
urlpatterns = [
    ...
    path('games/bulk-delete/', views.games_bulk_delete, name='games_bulk_delete'),
    path('games/reorder/', views.game_reorder, name='game_reorder'),
    path('games/<int:pk>/flags/', views.game_admin_flags, name='game_admin_flags'),
